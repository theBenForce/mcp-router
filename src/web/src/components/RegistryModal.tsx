          ...
          <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div className="p-4 border-b border-zinc-800/80 space-y-3 bg-zinc-900/40 shrink-0">
              ...
              <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
                {[
                  { id: "all", label: "All Servers", icon: Layers },
                  { id: "remote", label: "Remote (HTTP / SSE)", icon: Globe },
                  { id: "npm", label: "Node.js (npm)", icon: Terminal },
                  { id: "pypi", label: "Python (uvx / PyPI)", icon: Cpu },
                  { id: "docker", label: "Docker (OCI)", icon: Container },
                ].map((tab) => {
                  const Icon = tab.icon;
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all flex items-center gap-1.5 shrink-0 ${
                        isActive
                          ...
                          : "text-zinc-400 hover:text-zinc-200 hover:bg-zinc-900 border border-zinc-800/60"
                      }`}
                    >
                        ...
                        <div className="flex items-center justify-between gap-2 pt-2 border-t border-zinc-800/60 mt-1">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            <Button
                              ...
                              className="h-7 px-2.5 text-xs bg-indigo-600 hover:bg-indigo-500 text-white gap-1.5 shadow-sm shadow-indigo-500/20"
                            >
                              <span>Quick Add</span>
